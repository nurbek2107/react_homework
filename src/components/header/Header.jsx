...
const theneFromLocolS = () => {
  return localStorage.getItem('theme') || 'retro'
}
function Header() {

  const [theme, setTheme] = useState(theneFromLocolS)
  const handletheme = () => {
  ...
  return (
    ...
    <div className="center flex gap-10">
        <li className='list-none'><NavLink to='/'>Home</NavLink></li>
          <li className='list-none'><NavLink to='/about'>Abaut</NavLink></li>
        <li className='list-none hover:t'><NavLink to='/contact'>Contact</NavLink></li>
    ...
    <div className="right">
        <label className="swap swap-rotate">
          ...
          <input onClick={handletheme} type="checkbox" className="theme-controller" value="synthwave" checked={theme == 'draculapm '} />
