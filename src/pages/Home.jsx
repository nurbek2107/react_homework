...
function Home() {
  ...
  return (
    <div>
      {isPending && <div className="rounded-lg p-4 max-w-10 mx-auto h-lvh ">    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="200" height="200" style={{ shapeRendering: 'auto', display: 'block' }}>
        <g>
